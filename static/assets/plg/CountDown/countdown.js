...
;this.jbeeb = this.jbeeb || {}, function () {
    ...
    var s = 6e4, o = 36e5, r = 864e5, u = 0, d = 1, aR = 2, h = 3, l = 4, p = 5, c = 6,
        m = {ms: u, second: d, minute: aR, hour: h, day: l, month: p, year: c},
        f = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], g = function (t) {
    ...
    T.aK = !1, T.aJ = !1, T.aH = null, T.aE = null, T.aC = 0, T.aD = null, T.aL = 0, T.aG = c, T.aN = null, T.aP = null, T.start = function (t, e) {
        ...
        var n, a = new Date, i = 0;
        if (t instanceof Date) n = new Date(t.getTime()); else if ("object" == typeof t) {
            var r = t.year ? parseInt(t.year) : a.getFullYear(), u = t.month ? parseInt(t.month) - 1 : 0,
                d = t.day ? parseInt(t.day) : 0, aR = t.hour ? parseInt(t.hour) : 0,
                h = t.minute ? parseInt(t.minute) : 0, l = t.second ? parseInt(t.second) : 0,
        ...
        var a = 0, i = 0, s = 0, c = 0, m = 0, f = 0, g = 0, T = this.aE, U = T.getTime() - e.getTime(), v = Math.floor,
            C = !1, b = U, y = 0, D = 0, I = 0, w = 0, M = 0, E = 0;
        if (U > 0) {
            var H = 3600, F = this.aG;
            y = U / 1e3, D = y / 60, I = D / 60, w = I / 24, F >= u && (a = v(F == u ? U : U % 1e3)), F >= d && (i = v(F == d ? y : y % 60)), F >= aR && (s = v(F == aR ? D : D % 60)), F >= h && (c = v(F == h ? I : I % 24));
            var S = e.getUTCFullYear(), Z = e.getUTCMonth(), j = e.getUTCDate(), k = T.getUTCFullYear(),
                O = T.getUTCMonth(), Y = T.getUTCDate(), z = j, N = Y, L = 0;
            if (F >= l) if (F == l) m = v(w); else {
                var P = e.getUTCHours(), q = e.getUTCMinutes(), x = e.getUTCSeconds(), A = T.getUTCHours(),
                    B = T.getUTCMinutes(), G = T.getUTCSeconds(), J = O == Z ? 0 : -1, K = O + J;
                K < 0 && (K += 12);
                var Q = t(K, k);
                Q = Q < j ? t(K - 1, k) : Q, Q = Q < Y ? Y : Q;
                var R = 0;
                Y > j ? R = Y - j - 1 : Y < j && (R = j - Y - 1);
                var V = r - 1e3 * (x + 60 * q + P * H), W = 1e3 * (G + 60 * B + A * H);
                L = (V + W) / o, L < 24 && j++, j += R;
                var X = (Q - j + Y + R) % Q;
                m = v(X)
            }
...
;!function () {
    ...
    n.bc = null, n.aX = null, n.bt = !1, n.be = null, n.id = null, n.bk = !1, n.aV = null, n.totalFlipDigits = null, n.imageFolder = null, n.imageBasename = "flipper", n.imageExt = "png", n.by = null, n.aW = null, n.bf = "second", n.bq = !1, n.bg = null, n.bp = !1, n.bw = 0, n.bv = 0, n.bz = 0, n.bs = 0, n.bd = [], n.bb = {}, n.bi = 0, n.bh = 0, n.aT = null, n.init = function () {
        ...
        var c = o - a + 1, g = this.height, p = this.width / c, b = this.bq ? 0 : .25 * p, f = .1 * p, y = p - f,
            v = g - b, C = y * bA;
        ...
        for (var S = 0, R = [], u = 0; u < l.length; u++) {
            ...
            if (this.aW[F].use) {
                ...
                var D = this.by[F];
                if (D.store = {name: F}, this.bb[F] = y, "flip" == this.aV) {
                ...
                if (this.aX.addChild(D), !this.bq) {
                    var q = this.bg[F], G = g - .7 * b + T.labels.offset;
        ...
        if (1 === this.aZ) {
            var t = "opacity " + this.aY + "ms ease-out", e = this.aX.element.style;
        ...
        for (var t = !1, e = 0; e < this.bd.length; e++) {
            var i = this.bd[e], n = i.store.name, s = i.time.text, l = this.bx(s);
            l >= this.bw && l != this.bb[n] && (i.setWidth(l + this.bs), this.bb[n] = l + this.bs, t = !0)
        }
        if (t) for (var a = 0, e = 0; e < this.bd.length; e++) {
            var i = this.bd[e], s = i.time.text, l = this.bx(s);
        ...
        for (var i = 0; i < this.totalFlipDigits; i++) {
            var n = this.by[t].time.slot[i], s = this.aW[t], l = String(e).substr(i, 1), a = n.num[l];
            if (a) {
                if (s.prev[i] != l) {
